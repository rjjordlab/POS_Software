...
namespace POS_aplicacao.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FornecedorID,Nome,EIN,Telefone,Email,Morada")] Fornecedores fornecedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FornecedorID,Nome,EIN,Telefone,Email,Morada")] Fornecedores fornecedores)
        {
            if (ModelState.IsValid)
            {
